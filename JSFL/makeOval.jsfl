...
// makes groups of ovals (and reindexes) based on the w/h and instance root names.
...
function createCircle(elems, w, h, cx, cy)
{
	var c = (w == null || h == null) ? getCenter(elems) : {w:w, h:h};
...
function getCenter(elems)
{
	...
	// or set to zero to help with alignment
	//result.cx = 0;
	//result.cy = 0;
